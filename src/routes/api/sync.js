...
const PAGE_SIZE = 250;
const CHUNK_SIZE = 50;
const API_URL = "https://new-dc-api.onrender.com/api/dc/membership/all-customers";
const MAIN_API_URL = "https://new-dc-api.onrender.com/api/dc/membership/loyalty/update-stamps";
